...
genreSelectionLayout = html.Div([
    ...
    html.P('Please press F5 or refresh the page if you cannot select genre', style={"padding-left": "20px"}),
    html.Div([
